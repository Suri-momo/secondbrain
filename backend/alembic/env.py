...
# Import Base and all models (models must be imported for autogenerate to work)
from app.database import Base  # noqa: E402
from app.models import Conversation, Document, Message, Summary  # noqa: E402, F401
